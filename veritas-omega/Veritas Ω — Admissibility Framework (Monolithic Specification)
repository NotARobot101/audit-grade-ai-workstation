...
- rollback requires institutional, not technical, action,
...
Quiet failures are especially dangerous because they **bypass corrective feedback**.
...
- Costs must be estimable (even roughly)
- A responsible owner must exist
...
- Rollback timeline is shorter than harm propagation
- Entanglement risk is explicitly assessed

#### Automatic Fail Conditions
- Rollback depends on market, regulatory, or social cooperation
- Success increases lock-in
